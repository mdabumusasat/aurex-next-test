...
const ProductDetails = () => {
  ...
  return (
    ...
    <section className="product-details pt-120">
      <div className="md-container pb-70">
        <div className="row">
    ...
    <section className="product-description">
      <div className="md-container pt-0 pb-90">
                ...
                <div className="customer-comment">
                  <div className="row clearfix">
                    <div className="col-lg-6 col-md-6 col-sm-12 comment-column">
                      <div className="single-comment-box">
                        <div className="inner-box">
                          <figure className="comment-thumb"><img src="/assets/images/resource/testi1-1.jpg" alt="Image" /></figure>
                          <div className="inner">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 comment-column">
                      <div className="single-comment-box">
                        <div className="inner-box">
                          <figure className="comment-thumb"><img src="/assets/images/resource/testi1-2.jpg" alt="Image" /></figure>
                          <div className="inner">
                            <ul className="rating clearfix">
                              <li><i className="fas fa-star" /></li>
                              <li><i className="fas fa-star" /></li>
