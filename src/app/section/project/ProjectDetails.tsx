      ...
      <section className="project-details pt-120 pb-120">
        <div className="md-container">
          <div className="project-details__top">
            <div className="project-details__img fix"> <img data-speed=".8" src="/assets/images/resource/project-details.jpg" alt=""/> </div>
            <div className="project-details__details-box">
              <ul className="list-unstyled project-details__details-list">
                ...
                <li>
                  ...
                  <h6 className="project-details__name">25 February, 2026</h6>
                </li>
                <li>
          ...
          <div className="project-details__content">
            ...
            <Swiper {...swiperOptions} className="swiper project-image-slider mb-5">
              <SwiperSlide className="swiper-slide">
                <div className="image overflow-hidden">
                    <img data-speed="0.8" className="w-100" src="/assets/images/resource/project2-1.jpg" alt=""/>
                  </div>
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <div className="image overflow-hidden">
                  <img data-speed="0.8" className="w-100" src="/assets/images/resource/project2-2.jpg" alt=""/>
                </div>
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <div className="image overflow-hidden">
            ...
            <div className="row">
              ...
              <div className="col-lg-7">
                <p className="text">Must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure rationally encounter</p>
