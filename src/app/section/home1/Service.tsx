  ...
  return (
    <section className="service-section">
      <div className="container">
        <div className="sec-title-box mb-0">
          <div className="sec-title2 mb-0">
            <div className="sub-title">
              <div className="icon-img animation__rotateX">
                <img src="/assets/images/icons/sub-title1.png" alt="icon" />
              </div>
              What We provide
            </div>
          ...
          <Link href="/page-service-details" className="btn-style-three">
            <img src="/assets/images/icons/arrow-icon2.png" alt="arrow" />
            All Services
          </Link>
        </div>
