...
export default function TeamSection() {
  return (
    	<section className="team-details pt-120">
    		<div className="md-container pb-100">
    					...
    					<div className="col-xl-7 col-lg-6">
    						<div className="team-details__top-right">
    							<div className="team-details__top-content">
    								<h3 className="team-details__top-name">Sarah Lee <span className="color1">/ Managing Director</span></h3>
    								<p className="team-details__text-1 mb-0">Web designing in a powerful way of just not an only professions, however, in a passion for our Company. We have to a tendency to believe the idea that smart looking of any website is the first impression on visitors.</p>
            ...
            <p className="team-details__bottom-left-text">Web designing in a powerful way of just not an only professions, however, in a passion for our Company. We have to a tendency to believe the idea that smart looking of any website is the first impression on visitors.Sed ut perspiciatis unde omnis natus error sit voluptatem accusa ntium doloremque laudantium totam rem aperiamea queipsa quae abillo inventore veritatis et quasi architecto beatae There are many variations</p>
    				<div className="row">
                  ...
                  <form id="contact_form" name="contact_form" action="#" method="post">
                    ...
                    <div className="mb-3 theme-btn-main text-center">
                      ...
                      <button type="submit" className="btn-style-four justify-content-center" data-loading-text="Please wait...">
                  ...
                  <h4 className="team-details__bottom-left-title">Expertise & Skills</h4>
    							<p className="team-details__bottom-left-text">Bring to the table win-win at survival strategies win to ensure with proactiv other domination going with forward, a new normal that has evolved from generation X is on the runway heading towards a streamled solution survival strategies ensure adipisci impedit ab cloud</p>
